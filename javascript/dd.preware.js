dd.preware.extend({
    ...
    animateFadeOut:function()
    {
        ...
        for(var i in o)
        {
            setTimeout((function(t){return function(){dd.preware.animateOverlayHandle(t);};})(o[i]), i * 50);
        }
    },
    ...
    animatePageFadeOut:function()
    {
        ...
        for(var i in o)
            this.timers[i] = setTimeout((function(t){return function(){dd.preware.animatePageHandle(t);};})(o[i]), i * 50);
    },
